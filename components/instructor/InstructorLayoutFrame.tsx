...
import { ThemeProvider, useTheme } from '../student/ThemeContext';
...
export default function InstructorLayoutFrame({ user, children }: InstructorLayoutFrameProps) {
  return (
    <ThemeProvider>
      <InstructorLayoutContent user={user}>{children}</InstructorLayoutContent>
    </ThemeProvider>
  );
}

function InstructorLayoutContent({ user, children }: InstructorLayoutFrameProps) {
