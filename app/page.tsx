...
export default function Home() {
  const featuredCourses = [
    ...
    },
    {
      ...
      duration: '12 Weeks',
      studentsCount: '290 Enrolled',
      tutor: 'Mr. Light',
      description: 'Build autonomous AI agents, workflow automations, LLM integrations, and intelligent systems.',
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 text-xs">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><Link href="/staff/onboarding" className="hover:text-white transition">Staff Intake Form</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            <h4 className="font-bold text-white uppercase tracking-wider text-[11px]">Legal & Administration</h4>
            <ul className="space-y-2 text-gray-400">
